...
const EmployeeAuth = () => {
  ...
  console.log(process.env.REACT_APP_RECAPTCHA_SITE_KEY, "RECAPTCHA_SITE_KEY");

  const { mutate } = usePostMutation<{ token: string }>(
    ...
    (err) => {
      toast.error("Error verifying reCAPTCHA");
    }
  );
          ...
          <AnimatePresence mode="wait">
            {!registrationSuccess ? (
                    ...
                    onSubmit={async (values) => {
                      ...
                      mutate(
                        { token: captchaToken },
                        {
                          ...
                          onError: (err) => {
                            toast.error(
                              err.message || "Error verifying reCAPTCHA"
                            );
                          },
                        }
                      );
              ...
              <div className="text-center p-6 max-w-md mx-auto bg-white rounded-lg shadow-md">
                ...
                <p className="flex justify-center mb-4 text-gray-600">
                  <svg
                    className="w-6 h-6 md:w-5 md:h-5 mr-1  text-gray-500"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
